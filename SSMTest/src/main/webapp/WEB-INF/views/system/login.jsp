    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#vcodeImg").click(function () {
                this.src = "get_codeC?t=" + new Date().getTime();
            });
            //登录按钮事件
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.success == true) {
                                window.location.href="goLoginSuccess";
            ...
            <div class="row cl">
                ...
                <div class="formControls col-8">
                    <input id="verifiCode" class="input-text radius size-L" name="verifiCode" type="text"
                           placeholder="验证码"
                           style="width: 200px;">
                    <img title="点击图片切换验证码哟 ~" id="vcodeImg" src="get_codeC" alt="#">
                </div>
            </div>
            <!-- 用户类型 -->
...
<!-- 页面底部版权声明 -->
<div class="footer">
    Copyright @ 2019 zwh. All rights reserved | 本人博客网站 : zwhzzz.top
</div>
</body>
</html>