        ...
        $(function () {
            ...
            $("#editDialog").dialog({
                ...
                onBeforeOpen: function () {
                    ...
                    $("#edit_grade_name").textbox('setValue', selectRow.gradeId);
            ...
            $("#search-btn").click(function () {
                $('#dataList').datagrid('load', {
                    ...
                    gradeId: $('#search-gradeId').combobox('getValue')//获取年级名称
                });
            });
...
<div id="toolbar">
    ...
    <div style="margin-left: 10px;">
        ...
        <select id="search-gradeId" style="width: 155px;" class="easyui-combobox" name="gradeId">
        ...
        <input id="search-clazzname" class="easyui-textbox" name="name"/>
        <!-- 搜索按钮 -->
