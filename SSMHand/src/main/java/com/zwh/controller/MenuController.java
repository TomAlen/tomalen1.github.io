...
public class MenuController {
    ...
    public Map<String,Object> getMenuList(@RequestParam(value = "name",required = false,defaultValue = "")String name,
                                          Integer rows, Integer pages, Page page) {
        ...
        result.put("rows",menuService.get_Menu_List(queryMap));
        result.put("total",menuService.getCount(queryMap));

       /* //把搜得的结果封装成List对象
        List<Menu> menu_list = menuService.get_Menu_List(queryMap);
        //PageHelper插件
