...
import com.zwh.service.AuthorityService;
import com.zwh.service.MenuService;
import com.zwh.service.RoleService;
...
public class RoleController {
    ...
    public Map<String,Object> getList(
        ...
        List<Role> list = roleService.get_Role_List(queryMap);
        int total = roleService.getCount(queryMap);
    ...
    public List<Menu> getAllMenu() {
        ...
        return menuService.get_Menu_List(queryMap);
    }
